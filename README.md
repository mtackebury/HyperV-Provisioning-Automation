...
This PowerShell script automates the creation and updating of Hyper-V
virtual machines.
...
-   Automatically creating new VHDX files
...
The script is designed to be idempotent-aware and safe for repeated
execution.
...
-   Uses the Hyper-V host’s default VirtualHardDiskPath if no VHD folder
    is specified
...
Parameters
  ...
  MemoryMB        Int        No           2048             Startup memory
                                                           in MB

  CPU             Int        No           2                Number of
                                                           virtual
                                                           processors

  VHDSizeGB       Int        No           64               Size of the VHD
                                                           in GB
...
If the VM is running, the script will:
...
This project demonstrates infrastructure automation using PowerShell in
a Hyper-V environment.
It focuses on safe execution, input validation, and lifecycle management
of virtual machines.
